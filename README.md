...
<!-- HEADER BANNER -->
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:090D16,40:1E1B4B,100:0F172A&height=230&section=header&text=Soumyadip%20Das&fontSize=54&fontColor=ffffff&fontAlignY=36&desc=AI%20Engineer%20%7C%20Full-Stack%20Developer%20%7C%20GenAI%20Specialist&descSize=16&descAlignY=56&animation=fadeIn" width="100%"/>
</div>
...
<div align="center">
  ...
  <a href="https://customer-churn-prediction-am9rjlvuk7zwa8w.streamlit.app/">
    <img src="https://img.shields.io/badge/Churn_Predictor-Live_App-FF6600?style=for-the-badge&logo=streamlit&logoColor=white" alt="Churn Predictor"/>
  </a>
  &nbsp;
...
<p>
  ...
  <img src="https://img.shields.io/badge/FAISS-Vector_Search-6E56CF?style=for-the-badge&logoColor=white"/>
  <img src="https://img.shields.io/badge/RAG-Retrieval_Augmented-302b63?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Prompt_Engineering-NLP-24243e?style=for-the-badge"/>
</p>
...
### Web Frontend & Data Visualization
<p>
  <img src="https://img.shields.io/badge/React-61DAFB?style=for-the-badge&logo=react&logoColor=black"/>
  <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=for-the-badge&logo=javascript&logoColor=black"/>
  <img src="https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=for-the-badge&logo=tailwind-css&logoColor=white"/>
  <img src="https://img.shields.io/badge/Streamlit-FF4B4B?style=for-the-badge&logo=streamlit&logoColor=white"/>
  <img src="https://img.shields.io/badge/Recharts-22D3EE?style=for-the-badge&logoColor=white"/>
</p>
...
**Pipeline:** `Query` → `HuggingFace Embed` → `FAISS Search` → `LangChain Synthesis`

`FAISS` `LangChain` `RAG` `FastAPI` `HuggingFace` `NLP`

<br/>

<a href="https://github.com/soumyadip-das-dev/Legal-AI-Research-Assistant">
  <img src="https://img.shields.io/badge/View_Repository-181717?style=for-the-badge&logo=github" alt="Repo"/>
</a>
...
**Pipeline:** `User Input` → `Express REST` → `MongoDB + Rules` → `React Dashboard`

`React` `Node.js` `MongoDB` `Express` `Recharts` `Tailwind`

<br/>

<a href="https://ai-finance-tracker-pi-five.vercel.app">
  <img src="https://img.shields.io/badge/Live_Demo-00d9ff?style=for-the-badge&logo=vercel&logoColor=black" alt="Demo"/>
</a>
&nbsp;
<a href="https://github.com/soumyadip-das-dev/Finance-Tracker">
  <img src="https://img.shields.io/badge/View_Repo-181717?style=for-the-badge&logo=github" alt="Repo"/>
</a>
...
**Pipeline:** `Natural Language Question` → `Gemini Prompt Pipeline` → `SQL Output`

`Python` `Google Gemini` `NLP` `Text-to-SQL` `LLM`

<br/>

<a href="https://github.com/soumyadip-das-dev/English-to-SQL-Query-Generator">
  <img src="https://img.shields.io/badge/View_Repository-181717?style=for-the-badge&logo=github" alt="Repo"/>
</a>
...
**Pipeline:** `Historical Data` → `Feature Engineering` → `XGBoost Model` → `Risk Metrics`
...
<a href="https://customer-churn-prediction-am9rjlvuk7zwa8w.streamlit.app/">
  <img src="https://img.shields.io/badge/Live_App-FF6600?style=for-the-badge&logo=streamlit&logoColor=white" alt="App"/>
</a>
&nbsp;
<a href="https://github.com/soumyadip-das-dev/Customer-Churn-Prediction">
  <img src="https://img.shields.io/badge/View_Repo-181717?style=for-the-badge&logo=github" alt="Repo"/>
</a>
...
![Updated](https://img.shields.io/badge/Updated-Jun%202026-302b63?style=flat-square)

> ML system predicting loan approval probability with risk assessment & financial metrics.

**Pipeline:** `Applicant Data` → `Scikit/XGBoost Classifier` → `Streamlit Interface`

`XGBoost` `Scikit-learn` `Streamlit` `Risk Assessment`
...
> Multi-tool dashboard combining 8 essential student utilities into a single responsive web app.

**Features:** `Attendance Tracker` · `CGPA Calculator` · `Expense Splitter` · `Quiz System`

`JavaScript` `CSS Grid` `Flexbox` `Animations` `Responsive`

<br/>

<a href="https://github.com/soumyadip-das-dev/CAMPUS-UTILITY-HUB">
  <img src="https://img.shields.io/badge/View_Repository-181717?style=for-the-badge&logo=github" alt="Repo"/>
</a>
...
<a href="https://linkedin.com/in/soumyadip-das-4201931b5">
  <img src="https://img.shields.io/badge/LinkedIn-Soumyadip%20Das-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/>
</a>
&nbsp;
<a href="mailto:dassoumyadip180@gmail.com">
...
> **Actively seeking AI / Full-Stack internships & research roles.**  
> *Building real-world AI applications — feel free to reach out or collaborate.*
